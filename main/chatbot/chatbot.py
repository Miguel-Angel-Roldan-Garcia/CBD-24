...
class MovieChatbot:
    def __init__(self, root, data_miner):
        self.root = root
    ...
    def classify_genre(self, description):
        predicted_genre = "Hola" #self.dataMiner.classify(description)
    ...
    def send_message(self):
        ...
        if user_message:
            ...
            if user_message.lower() == 'bye':
                ...
                self.chat_display.insert(tk.END, "Chatbot: This movie could be categorized as '" + genre + "'.\n")
            ...
            self.chat_display.insert(tk.END, "You: [Message cannot be empty]\n")
            self.chat_display.see(tk.END)  # Scroll to the bottom of the chat display
...
def run():
    ...
    chatbot = MovieChatbot(root, None)
    chatbot.mainloop()